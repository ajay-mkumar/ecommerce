        ...
        <Col md={4}>
            ...
            <ListGroup variant='flush'>
                <ListGroupItem>
                    ...
                    Rs.{cartItem.reduce((acc,itm)=>acc+itm.qty*itm.price,0).toFixed(2)}
                </ListGroupItem>
                <ListGroupItem>
                    <Button type='button' onClick={()=>navigate('/shipping')} className='btn-block' disabled={cartItem.length<=0}>
                        Proceed to checkout
                    </Button>
                </ListGroupItem>
            </ListGroup>
